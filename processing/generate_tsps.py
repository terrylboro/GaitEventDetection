...
if __name__ == '__main__':
    for algorithm in ["TP-EAR"]:
        for activityName in ["WalkShake"]:
            diffsDF = pd.read_csv('../data/{}/RawDiffs/{}DiffsRawOverall.csv'.format(algorithm, activityName),
            ...
            # Format and save the summary dfs
            if activityName == "TUG":
                save_tsps(overallTSPsTurnsdf, "../data/{}/TSPs/TUG Turns {} TSPs Summary.csv".format(algorithm, algorithm))
                save_tsps(overallTSPsNonTurnsdf, "../data/{}/TSPs/TUG Non Turns {} TSPs Summary.csv".format(algorithm, algorithm))
            else:
                save_tsps(overallTSPsdf, "../data/{}/TSPs/{} {} TSPs Summary.csv".format(algorithm, activityName, algorithm))
